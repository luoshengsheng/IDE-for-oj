...
function initialise(options) {
    ...
    //设置语言代码模板
    setAttr("templateC", $(".template.lang.c").text());
    setAttr("templateCC", $(".template.lang.cc").text());
    setAttr("templateJava", $(".template.lang.java").text());

    var language = getAttr("language");
    if (!language) {
